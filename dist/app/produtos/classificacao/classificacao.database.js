...
exports.classificacaoFindByCodigoRemove = function (classificacao) { return __awaiter(_this, void 0, void 0, function () {
    var col, query;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongodb_1.classificacaoCollection];
            case 1:
                col = _a.sent();
                query = { spreadsheetId: classificacao.spreadsheetId };
