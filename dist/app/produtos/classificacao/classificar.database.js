...
exports.classificarSave = function (classificar) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                col = _a.sent();
                return [4 /*yield*/, col.insertOne(classificar).catch(function (e) {
                        console.log(e);
                    })];
            case 2:
                _a.sent();
...
exports.classificacaoUpdate = function (classificar) { return __awaiter(_this, void 0, void 0, function () {
    var col, query, newClassificar;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongodb_1.classificarCollection];
            case 1:
                ...
                newClassificar = { $set: classificar };
                return [4 /*yield*/, col.updateOne(query, newClassificar).catch(function (e) {
                        console.log(e);
                    })];
            case 2:
                _a.sent();
...
exports.classificarFindAll = function () { return __awaiter(_this, void 0, void 0, function () {
    var col;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongodb_1.classificarCollection];
...
exports.classificarFindByCodigo = function (codigo) { return __awaiter(_this, void 0, void 0, function () {
    var col;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongodb_1.classificarCollection];
...
exports.classificarFindMaxCodigo = function () { return __awaiter(_this, void 0, void 0, function () {
    var col;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongodb_1.classificarCollection];
