    ...
    return __generator(this, function (_a) {
        ...
        db.categoriasFormularioFindAll().then(function (categorias) {
            ...
            if (categorias.length > 0) {
                ...
                categoria.codigo = getCodigoCategoria(categorias);
                var ret = db.categoriasFormSave(categoria);
            }
            res.send('200');
        });
...
exports.delCategoriasForm = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var categoria;
    return __generator(this, function (_a) {
        categoria = req.body;
        if (categoria.codigo != undefined) {
            db.categoriasFormularioFindByCodigoRemove(categoria).then(function () {
                res.send('200');
            });
        }
        return [2 /*return*/];
